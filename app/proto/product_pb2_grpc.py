...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetProduct = channel.unary_unary(
                ...
                request_serializer=product__pb2.PID.SerializeToString,
                response_deserializer=product__pb2.PInfo.FromString,
                )
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetProduct': grpc.unary_unary_rpc_method_handler(
                    servicer.GetProduct,
                    request_deserializer=product__pb2.PID.FromString,
                    response_serializer=product__pb2.PInfo.SerializeToString,
            ),
    }
...
class ProductService(object):
    ...
    def GetProduct(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/product.ProductService/GetProduct',
            product__pb2.PID.SerializeToString,
            product__pb2.PInfo.FromString,
